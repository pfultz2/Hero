...
#define HERO_PP_ENUM_SEQ_1(...) __VA_ARGS__ HERO_PP_ENUM_SEQ_2
#define HERO_PP_ENUM_SEQ_2(...) , __VA_ARGS__ HERO_PP_ENUM_SEQ_3
#define HERO_PP_ENUM_SEQ_3(...) , __VA_ARGS__ HERO_PP_ENUM_SEQ_2
#define HERO_PP_ENUM_SEQ_1_END
#define HERO_PP_ENUM_SEQ_2_END
#define HERO_PP_ENUM_SEQ_3_END
...
#define HERO_PP_ACCESS_FIELDS_1_END
#define HERO_PP_ACCESS_FIELDS_2_END
...
#define HERO_PP_STRUCT_DECLARE_FIELDS_1_END
#define HERO_PP_STRUCT_DECLARE_FIELDS_2_END
