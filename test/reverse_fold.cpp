...
PROVE_CASE()
{
    ...
    int result = t | hero::reverse_fold(0, fit::match(
...
PROVE_CASE()
{
    ...
    int n = hero::reverse_fold(t, tick::integral_constant<int, 0>(), fit::_1 + 1);
    PROVE_CHECK(n == 1);
}
...
PROVE_CASE()
{
    ...
    std::string s = hero::reverse_fold(t, std::string(""), fit::_1 + fit::_2);
